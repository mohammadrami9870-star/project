const products = [
    { id: 1, cat: 'hardware', name: 'DJI Mini 4 Pro', price: 780, descriptive: 'طائرة بدون طيار صغيرة الحجم تصور بدقة 4K مع حساسات تجنب الاصطدام.', img: 'https://stormsend1.djicdn.com/tpc/uploads/spu/cover/4ea419b081f38056785ae8665d473190@ultra.png' },
    { id: 2, cat: 'accessories', name: 'DJI Goggles 2', price: 540, descriptive: 'نظارات الطيران المباشر لتجربة منظور الشخص الأول (FPV) وكأنك تحلق.', img: 'https://cdn.shopify.com/s/files/1/0123/4406/6148/products/djigoggle2_1024x.png?v=1669068646' }
];
let cart = [];
let lastOrderID = "";
